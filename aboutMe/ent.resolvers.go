...
// Hobbies is the resolver for the hobbies field.
func (r *queryResolver) Hobbies(ctx context.Context, after *entgql.Cursor[int], first *int, before *entgql.Cursor[int], last *int, orderBy []*ent.HobbyOrder, where *ent.HobbyWhereInput) (*ent.HobbyConnection, error) {
	return r.client.Hobby.Query().
		Paginate(ctx, after, first, before, last,
			ent.WithHobbyOrder(orderBy),
			ent.WithHobbyFilter(where.Filter),
		)
}
